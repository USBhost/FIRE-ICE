...
#elif defined(CONFIG_CPU_FREQ_DEFAULT_GOV_SUBLIMEACTIVE)
extern struct cpufreq_governor cpufreq_gov_sublimeactive);
#define CPUFREQ_DEFAULT_GOVERNOR	(&cpufreq_gov_sublimeactive)
